...
public class UtilitiesParticipants {
    ...
    public void RegisterDataDefaultParticipant(SQLiteConnectionHelper conn){
        ...
        InsertParticipants.add("INSERT INTO PARTICIPANTS(participant_id,participant_identification_type,participant_identification_id,participant_name) VALUES (6,'CC'51236526Yenny ANdre Castro')");
