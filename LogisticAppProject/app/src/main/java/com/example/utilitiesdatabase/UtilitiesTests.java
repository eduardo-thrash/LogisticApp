...
public class UtilitiesTests {
    ...
    public void RegisterDataDefaultTest(SQLiteConnectionHelper conn){
        ...
        InsertTest.add("INSERT INTO TESTS(test_id,test_code,status_id,participant_id,room_id)VALUES(7,'TS00000007',3,7,1)");
        InsertTest.add("INSERT INTO TESTS(test_id,test_code,status_id,participant_id,room_id)VALUES(8,'TS00000008',3,8,1)");
        InsertTest.add("INSERT INTO TESTS(test_id,test_code,status_id,participant_id,room_id)VALUES(9,'TS00000009',3,9,1)");
